...
//             <button
//               onClick={handleCopy}
//               className="flex gap-2 bg-gray-500 text-white font-semibold px-3 py-1 rounded-lg"
//             >
    ...
    <div className="min-h-[85vh] bg-gray-900 text-white">
      ...
      <div className="summarized-size pt-2 flex flex-col items-center gap-3">
        ...
        <div className="submit">
          <button
            onClick={handleSummarize}
            className="bg-gradient-to-r from-gray-500 to-gray-900 text-white font-bold px-4 py-2 md:px-6 md:py-3 rounded-xl shadow-lg shadow-gray-600/40 hover:scale-105 active:scale-95 transition-all duration-300"
          >
            Summarize
          </button>
        </div>
